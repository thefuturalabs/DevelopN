        ...
        <form  method="post" role="form" class="" data-aos="fade-up" data-aos-delay="100">
          <div class="row">
            <div class="col-lg-4 col-md-6 form-group">
              <input type="text" name="user" class="form-control" id="name" placeholder="Useename" data-rule="minlen:4" data-msg="Please enter at least 4 chars">
          ...
          <div class="row">
            <div class="col-lg-4 col-md-6 form-group mt-3 mt-md-0">
              <input type="password" class="form-control" name="pass" id="email" placeholder="Password" data-rule="email" data-msg="Please enter a valid email">
              <div class="validate"></div>
            </div>
