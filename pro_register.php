...
$query = mysqli_query($conn, "INSERT INTO login(`username`,`password`,`type`) VALUES('$username','$password','provider')");
$last_login_id = mysqli_insert_id($conn);
// var_dump($last_login_id);exit();
$query1 = mysqli_query($conn, "INSERT INTO `providers`(`login_id`,`name`,`email`,`phn_no`,`qualification`,`gender`,`work_status`,`image`) VALUES ('$last_login_id','$name','$email','$phn_no','$qualification','$gender','$work_status','$filenew')");
